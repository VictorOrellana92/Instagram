...
@interface InstagramObject : KrollCoverageObject {
#else
@interface InstagramObject : KrollObject {
#endif
@private
...
extern NSString * Instagram$ModuleRequireFormat;
