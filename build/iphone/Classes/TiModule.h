...
/**
 The base class for all Instagram modules
 */
...
/**
 Instagram Platform calls this method on startup.
 */
-(void)startup;

/**
 Instagram Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 Instagram Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 Instagram Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 Instagram Platform calls this method on resume.
 @param sender The sender of the event.
 */
