...
/**
 Base class for all Instagram views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the Instagram view hierarchy (such as wrapped iOS UIViews) was touched.
