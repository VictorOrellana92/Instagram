...
// in simulator we redefine to format for Instagram Developer console
...
{\
	NSString * exceptionName = [@"org.instagram." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.instagram";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIInstagramNativeItemNone = -1, 
	UIInstagramNativeItemSpinner = -2,
	UIInstagramNativeItemProgressBar = -3,
	
	UIInstagramNativeItemSlider = -4,
	UIInstagramNativeItemSwitch = -5,
	UIInstagramNativeItemMultiButton = -6,
	UIInstagramNativeItemSegmented = -7,
	
	UIInstagramNativeItemTextView = -8,
	UIInstagramNativeItemTextField = -9,
	UIInstagramNativeItemSearchBar = -10,
	
	UIInstagramNativeItemPicker = -11,
	UIInstagramNativeItemDatePicker = -12,
	
	UIInstagramNativeItemInfoLight = -13,
	UIInstagramNativeItemInfoDark = -14,
	
	UIInstagramNativeItemDisclosure = -15,
	
	UIInstagramNativeItemContactAdd = -16
};
...
#endif
/**
 *	TiThreadPerformOnMainThread should replace all Instagram instances of
